...
public final class TestUser {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        List<Price> locPriceList = locRESTManager.getQuotesList(1845, "2016-01-01", "2020-10-23");
        ...
        DynAmountLineAssetModel locNewLine = new DynAmountLineAssetModel(1860, 6.0);
        DynAmountLineAssetModel locNewLine2 = new DynAmountLineAssetModel(1900, 10.0);
        locLinesList.add(DynAmountLineContainerModel.of(locNewLine));
        locLinesList.add(DynAmountLineContainerModel.of(locNewLine2));
        Map<String, List<DynAmountLineContainerModel>> locNewCompo = new HashMap<>();
        locNewCompo.put("2018-01-01", locLinesList);
        ...
        System.out.println("--- AVANT ---");
        Portfolio locPtfUser2 = locRESTManager.getPortfolio(RESTManager.ID_PTF_REF);
        if (locPtfUser2 == null) {
            return;
        }
        System.out.println(locPtfUser2);
        locPtfUser2._values = locNewCompo;
        locRESTManager.pushPortfolio(RESTManager.ID_PTF_REF, locPtfUser2);
        locPtfUser2 = locRESTManager.getPortfolio(RESTManager.ID_PTF_REF);
        System.out.println("--- APRES ---");
        System.out.println(locPtfUser2);
