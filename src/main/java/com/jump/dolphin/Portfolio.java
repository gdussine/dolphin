...
import com.jump.dolphin.AssetCurrency;
import com.jump.dolphin.DynAmountLineContainerModel;
import com.jump.dolphin.EnumDynAmountTypeWebModel;
...
public class Portfolio {
  ...
  public void addValue(Integer asset, Double qty, String date){
    _values.get(date).add(DynAmountLineContainerModel.of(new DynAmountLineAssetModel(asset, qty)));
  }
