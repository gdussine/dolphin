...
import com.jump.dolphin.AssetCurrencyManager;
...
public final class Evaluation {
     ...
     */
    public static List<Integer> PORTFOLIO_ID_LIST = Arrays.asList(1829, 1830, 1831, 1832, 1833, 1834, 1835, 1836, 1837, 1838, ID_PTF_REF);
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        PORTFOLIO_ID_LIST.forEach(parId -> {
